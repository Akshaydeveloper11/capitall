												...
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li><a class="dropdown-item" href="investors.php">Investors</a></li>
														</ul>
													</li>
													<li class="dropdown"><a class="dropdown-item dropdown-toggle active" href="blogs.php">Blog</a></li>
													<li class="dropdown"><a class="dropdown-item dropdown-toggle active" href="contact-us.php">Contact</a></li>
												</ul>
											</nav>
										</div>
									</div>
								...
								<div class="header-row ps-5 justify-content-end">
									<div class="header-nav-features-search-reveal-container">
										<div class="header-nav-feature header-nav-features-search header-nav-features-search-reveal d-inline-flex">
											...
											<a href="https://kgskonnect.com/" class="d-inline-flex text-decoration-none"><i class="fas fa-user header-nav-top-icon"> Login</i></a>
										</div>
									</div>
								</div>
							</div>
